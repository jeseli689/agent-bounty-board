...
async function main() {
    console.log("🦞 Deploying BountyBoard v4 (Treasury Slashing) to Base Sepolia Testnet...");
    ...
    // 2. Load v4 Artifacts
    const artifactPath = path.resolve(__dirname, '../BountyBoard_v4.json');
    ...
    try {
        ...
        console.log(`✅ BountyBoard v4 Deployed: ${address}`);
