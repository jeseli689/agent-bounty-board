...
async function main() {
    console.log("🦞 Deploying BountyBoard v2 to Base Sepolia Testnet...");
    ...
    // 2. Load v2 Artifacts (Updated ABI/Bytecode)
    const artifactPath = path.resolve(__dirname, '../BountyBoard_v2.json');
    ...
    try {
        ...
        console.log(`✅ BountyBoard v2 Deployed: ${address}`);
